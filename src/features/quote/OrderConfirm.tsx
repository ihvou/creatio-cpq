import { CheckCircle2, ShoppingCart, Truck, Send, Bookmark } from 'lucide-react'
...
export function OrderConfirm() {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-auto">
      <div className="max-w-[520px] mx-auto bg-surface border border-line rounded-md shadow-card p-6 text-center">
        ...
        <Button className="mt-5" onClick={() => setView('catalog')}>Back to catalogue</Button>
      </div>
    </div>
  )
}
